            ...
            <div key={study.id} className={`group flex flex-col lg:flex-row gap-20 ${idx % 2 !== 0 ? 'lg:flex-row-reverse' : ''}`}>
              <div className="flex-1">
                <div className="overflow-hidden rounded-[2.5rem] shadow-2xl relative">
                  <div className="absolute inset-0 bg-gradient-to-t from-slate-950/60 via-transparent to-transparent z-10 opacity-50 transition-opacity duration-500 group-hover:opacity-30"></div>
                  <img 
                    src={study.image} 
                    alt={study.title} 
